...
describe("Heap behaviour", function () {
    ...
    it("can do min-heap", function(){
        var h = new Heap(Heap.MIN);
    ...
    it("supports Objects and Keys", function () {
        var h = new Heap();
        var str = "Apples";
        var obj = {
            fruits: "Apples",
        ...
        var retrievedStr = h.pop();
        var retrievedObj = h.pop();
        
        expect(retrievedObj).toBe(obj);
        expect(retrievedStr).toBe(str);
    });
});